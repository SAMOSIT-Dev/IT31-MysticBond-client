...
export default function ResultTab({ houseData = {} }) {
  return (
      ...
      <div className="flex flex-col">
        {houseData?.title ? (
          <div className="mx-auto text-center max-w-120">
            ...
            <p className="text-5xl font-inria-serif my-10">{houseData.title}</p>
            <p className="text-xl leading-normal">{houseData.description}</p>
            <Button className="max-w-90 w-full mx-auto mt-10">เสร็จสิ้น</Button>
          </div>
        ) : (
          <div className="mx-auto text-center">
            ...
            <p className="text-3xl leading-normal">โปรดรอการประกาศผลอีกครั้งในวันข้างหน้า</p>
            ...
            <Button className="max-w-90 w-full mx-auto mt-7.25">เสร็จสิ้น</Button>
          </div>
        )}
      </div>
    </StepTabContent>
