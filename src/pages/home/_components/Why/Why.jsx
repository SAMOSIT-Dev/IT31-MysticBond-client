...
export default function Why() {
  return (
    <div className="pb-12 relative">
      <div className="why-bg w-[50vw] h-full absolute left-0 top-0 z-[-1] rotate-y-180"></div>
      <div className="z-4">
        <div className="text-center pt-30 mb-15">
          <h4 className="text-white text-3xl font-normal">
            ทำไมถึงควรลงกิจกรรมนี้
          </h4>
        </div>
            ...
            <ReasonCard>
              ...
              <div className="font-line-seed-sans">
                ...
                <p className="text-sm font-normal">
                  นี่ไม่ใช่แค่การรับน้อง แต่มันคือการเริ่มต้นตำนานของคุณ
                  ค่ำคืนนี้คือบทแรกของสายสัมพันธ์ที่ไม่มีวันจางหาย
                  กับโลกเวทมนตร์ที่เลือกคุณ
                </p>
              </div>
            </ReasonCard>
            <ReasonCard>
              ...
              <div className="font-line-seed-sans">
                <h3 className="text-4xl mb-3">เหตุผล</h3>
                <p className="text-sm font-normal">
                  เพราะสัตว์วิเศษไม่ได้เลือกจากสายตา แต่มันฟังจากหัวใจของผู้กล้า
                  เงาในม่านหมอกรอให้คุณยอมรับตัวตน และค้นพบพลังที่คุณมีมาตลอด
                </p>
              </div>
            </ReasonCard>
            <ReasonCard className="lg:col-span-full xl:col-span-1">
              <div className="flex justify-between">
                <div className="w-34 h-31.5 mb-5 mt-11 relative">
              ...
              <div className="font-line-seed-sans">
                <h3 className="text-4xl mb-3">เหตุผล</h3>
                <p className="text-sm font-normal">
                  คุณจะไม่เดินลำพังอีกต่อไป เมื่อหัวใจเต้นเป็นจังหวะเดียวกัน
                  คุณจะรู้ว่าคุณคือส่วนหนึ่งของสายใยที่ยิ่งใหญ่กว่าสายเลือด
                </p>
              </div>
            </ReasonCard>
          </div>
