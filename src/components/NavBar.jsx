...
export default function NavBar({ isRootPage = false }) {
  ...
  return (
    <>
      <nav
        className="z-50 h-[73px] w-full fixed top-1/12 px-[9%] flex items-center justify-center lg:justify-between"
      ...
      >
        ...
        <button onClick={() => navigate("/auth/login")} className="cursor-pointer px-8 py-3 text-md border-2 border-[#202020] shadow-[0_0_1rem] shadow-[#f4f4f449] bg-[radial-gradient(circle_at_top,_#000000,_#000000,_#262626,_#4F4F4F)] rounded-[44px] duration-300 hover:shadow-[0_0_1.5rem] hover:shadow-[#f4f4f480]">
          เข้าสู่ระบบ
        </button>
      </nav>
    </>
